...
class FoodList(models.Model):
    ...
    todayIs = models.DateField(u'Today is', help_text=u'This will be helpful to calculate the expiration date', default=d.date,  blank=True)
    ...
    def __str__(self):
        ...
        return self.productName + " | " + self.productCategory + " | " + self.productStatus + " | " + str(self.productPrice) + "€"
